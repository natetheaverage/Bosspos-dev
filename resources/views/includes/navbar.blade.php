                            ...
                            <div class="nano-content">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a href="/exportSeed">
                                            <div class="clearfix">
                                                <p class="pull-left">Seed Current State</p>
                                            </div>
                                        </a>
                                    </li>
					...
					<a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
								<span class="pull-right">
									@if($currentUser->profile->profile_picture != null)
										<img alt="Profile Picture" class="img-circle img-user media-object" src="{!! asset('img/users/'.studly_case($currentUser->profile->last_name[0]).'/'.studly_case($currentUser->profile->last_name).studly_case($currentUser->profile->first_name).'/'.$currentUser->profile->profile_picture) !!}">
									@else
										<img alt="Profile Picture" class="img-circle img-user media-object" src="{!! asset('img/av'.rand(1,6).'.png') !!}">
									@endif
								</span>
						<div class="username hidden-xs"> {!! $currentUser->profile->first_name !!} {!! studly_case($currentUser->profile->last_name) !!}</div>
					</a>
